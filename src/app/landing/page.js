...
function Landing() {
    return (
        <div className="relative">
            <div
                className="header-bg fixed top-0 left-0 z-20 w-full h-24 justify-between px-32 items-center flex">
                ...
                <div className="justify-center items-center gap-6 inline-flex">
                    ...
                    {/*<div className="px-4 py-1 bg-indigo-500 rounded justify-center items-center gap-2.5 flex">*/}
                        {/*<button >{*/}
            ...
            <div className="w-full relative">
                <video className="w-full bg-contain" autoPlay muted playsInline loop src="/bg/cube-bg.mp4"/>
                <div className="w-1/2 h-screen absolute z-10 top-64 left-32 flex flex-col">
                    <div className="w-full text-white text-7xl font-bold">Transform Your <br/>Freelancing Journey
                    </div>
                    <div className="w-3/4 text-white text-2xl font-normal pt-12">Empowering Freelancers with Instant
                        Blockchain Payments and Customizable Smart Contracts.
                    </div>
                    {/*<div*/}
                    {/*    className="w-auto h-12 px-4 py-2.5 bg-gray-900 rounded-lg justify-center items-center gap-2.5 inline-flex">*/}
                    {/*    <button className="text-white text-2xl font-normal">Get started now</button>*/}
                    {/*</div>*/}
                </div>
            </div>
            <div className="w-full rounded-xl flex justify-around items-center p-32">
                    <div className="w-1/4 h-[577px] relative
                         card-bg
                         rounded flex-col justify-start items-start flex">
                        <img className="w-full h-auto p-8" src="/landing/4s1.png"/>
                        <div className="w-full h-auto relative ">
                            <div className="w-full p-8 text-center">
                                <span className="text-white text-xl font-medium">No Middlemen<br/></span>
                                <span
                                    className="text-white text-md font-normal"><br/>Bypass traditional financial intermediaries like banks and payment processors as you receive payments directly to your blockchain wallet. </span>
                            </div>
                    ...
                    <div
                        ...
                        card-bg h-[577px]
                         rounded flex-col justify-start items-start flex">
                        <img className="w-full h-auto p-8" src="/landing/4s.png"/>
                        <div className="w-full h-auto relative ">
                            <div className="w-full p-8 text-center">
                                <span className="text-white text-xl font-medium">Customized Smart Contracts<br/></span>
                                <span
                                    className="text-white text-md font-normal">
                                    <br/>
User-friendly interface to create personalized smart contracts tailored to your specific project requirements. No coding expertise needed</span>
                            </div>
                    ...
                    <div
                        className="w-1/4 h-[577px] relative
                         card-bg
                         rounded flex-col justify-start items-start flex">
                        <img className="w-full h-auto p-8" src="/landing/4s2.png"/>
                        <div className="w-full h-auto relative ">
                            <div className="w-full p-8 text-center">
                                <span className="text-white text-xl font-medium">Instant and Borderless Transactions<br/></span>
                                <span

                                    className="text-white text-md font-normal">
                                    <br/>
Say goodbye to lengthy processing times and international transfer fees. With direct blockchain wallet payments, enjoy instant, cross-border transactions</span>
                            </div>
            ...
            <div className="w-full relative">
                <div className="w-1/2  absolute -top-8 left-48 -z-10">
                    <img className="w-1/2" src="/landing/cube3.png"/>
                </div>
                <div className="w-1/2 absolute -top-8 -right-64 -z-10">
                    <img className="w-1/2" src="/landing/cube2.png"/>
                </div>
                <div className="text-center text-gray-900 text-5xl pt-32 font-bold">How does it work?</div>
                <div className="w-full flex justify-center items-center flex-col">
                    <div className="w-1/2 flex pt-16">
                        <div className="w-10 h-10 bg-indigo-500 rounded flex justify-center items-center p-2 mr-8">
                            <img src="/icons/pay.svg" alt="pay"/>
                        </div>
                        <div className="w-5/6">
                            <div className="text-gray-900 text-md font-bold leading-normal">Connect Your Wallet</div>
                            <div className="text-gray-900 text-xs font-normal leading-normal">Link your blockchain wallet effortlessly. New to wallets? No worries, our guidance will have you set up in no time</div>
                        </div>
                    </div>
                    <div className="w-1/2 flex pt-8">
                        <div className="w-10 h-10 bg-indigo-500 rounded flex justify-center items-center p-2 mr-8">
                            <img src="/icons/target.svg" alt="pay"/>
                        </div>
                        <div className="w-5/6">
                            <div className="text-gray-900 text-md font-bold leading-normal">Find or Post a Job</div>
                            <div className="text-gray-900 text-xs font-normal leading-normal">
                                Discover your ideal freelance gig or post a job to attract skilled freelancers. Our platform simplifies the process, making connections seamless.
                            </div>
                        </div>
                    </div>
                    <div className="w-1/2 flex pt-8">
                        <div className="w-10 h-10 bg-indigo-500 rounded flex justify-center items-center p-2 mr-8">
                            <img src="/icons/lock.svg" alt="pay"/>
                        </div>
                        <div className="w-5/6">
                            <div className="text-gray-900 text-md font-bold leading-normal">Secure Communication</div>
                            <div className="text-gray-900 text-xs font-normal leading-normal">
                                Engage in confidential discussions using our secure chat system. Your privacy is a priority as you hash out project details.
                            </div>
                        </div>
                    </div>
                    <div className="w-1/2 flex pt-8">
                        <div className="w-10 h-10 bg-indigo-500 rounded flex justify-center items-center p-2 mr-8">
                            <img src="/icons/heart.svg" alt="pay"/>
                        </div>
                        <div className="w-5/6">
                            <div className="text-gray-900 text-md font-bold leading-normal">Intuitive Contract Creation</div>
                            <div className="text-gray-900 text-xs font-normal leading-normal">
                                Create and finalize contracts hassle-free, even without coding skills. Our user-friendly interface ensures contracts match your project's unique needs. Funds are secured in your wallet, released only as per the agreement, guaranteeing total peace of mind.
                            </div>
                        </div>
                    </div>
            ...
            <div className="absolute bottom-64 -z-10">
                <img className="w-3/4 h-1/2" src="/landing/cube1.png"/>
            </div>
            <div className="w-full flex justify-center items-start h-64 bg-gray-900 mt-96 px-32">
                <div className="w-3/4 flex justify-center items-start">
                    <div className="w-1/3 px-8 pt-8">
                        <div className="text-white text-sm font-medium">
                            FOR CLIENTS<br/><br/><br/>
                            How to Hire<br/>
                            How it works<br/>
                            Find<br/>
                            Freelancer<br/>
                            More about contracts<br/>
                        </div>
                    </div>
                    <div className="w-1/3 px-8 pt-8">
                        <div className="text-white text-sm font-medium">
                            FOR FREELANCER<br/><br/><br/>
                            Why GooJob<br/>
                            Find a Job Invite client<br/>
                        </div>
                ...
                <div className="w-1/4 flex justify-center items-center px-8 pt-8 relative">
                    <img className="absolute top-0 bottom-0  z-0" src="/landing/Union.png" alt="logo"/>
                    <div className="text-white text-sm font-medium absolute z-10">Made with ♥ during ETHMunich</div>
                </div>
            </div>
        </div>
    );
